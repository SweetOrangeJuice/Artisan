...
public class SubMomentFragment extends Fragment {
    ...
    public static Fragment newInstance(){
        return new SubMomentFragment();
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_sub_moment,container,false);

        mBackImageView=(ImageView)view.findViewById(R.id.fragment_sub_moment_back);
        mRecyclerView=(RecyclerView)view.findViewById(R.id.fragment_sub_moment_recycler_view);
        mLoadingRelativeLayout=(RelativeLayout)view.findViewById(R.id.fragment_sub_moment_loading);
    ...
    private void loadData(){
        AsyncTask<String,Integer,Integer> task=new AsyncTask<String, Integer, Integer>() {
            ...
            protected Integer doInBackground(String... params) {
                ...
                List<String> objectIds= PersonalController.getMyMoments(100,0);
                ...
                for (int i=0;i<objectIds.size();i++){
                    ...
                    */
                    ...
                    AVObject result0;
                    try {
                        result0=query.getFirst();
                        byte[] headPortrait=FileController.getThumbnailbyObjectId((String)result0.get("headImage"),50,50);
